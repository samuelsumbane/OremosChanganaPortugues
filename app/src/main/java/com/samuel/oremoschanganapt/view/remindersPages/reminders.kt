            ...
            LazyColumn(
                ...
                items( allReminders ){ reminder ->
                    ...
                    Column(
                        ...
                        Row(
                            Modifier.fillMaxWidth(0.95f).height(40.dp),
                        ...
                        if (!showDetails){
                            Column(
                                ...
                                Row (
                                    ...
                                    NormalButton("Editar", BlueButton){
                                        val r = reminder
                                        navController.navigate("configurereminder/${r.reminderData}/${r.reminderTable}/${r.reminderDate}/${r.reminderTime}")
                                    }

                                    NormalButton("Deletar", RedButton) {
